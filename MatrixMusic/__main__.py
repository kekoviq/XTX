...
async def init():
    ...
    LOGGER("ميــوزك Alpha").info("MatrixThon")
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("ميــوزك Alpha").info("جارِ ايقاف بوت الميوزك . . .")
