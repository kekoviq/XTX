...
async def get_group_status(_, message: Message):
    if len(message.command) != 2:#BiLaL
        await message.reply("الرجاء تقديم اسم مستخدم المجموعة. مثال: معلومات المجموعة le_e_e")
        return
...
async def get_group_status(_, message: Message):
    if len(message.command) != 2:#BiLaL
        await message.reply("الرجاء تقديم اسم مستخدم المجموعة. مثال: معلومات القناة le_e_e")
        return
